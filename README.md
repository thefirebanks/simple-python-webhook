# Flask Simple Webhook for Instana Events


Based on template from a [sample flask application running on OpenShift](https://github.com/OpenShiftDemos/os-sample-python). Original README below.
